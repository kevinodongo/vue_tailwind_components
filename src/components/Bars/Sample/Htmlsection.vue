<template>
  <div class="sample-html" style="background-color: #f5f2f0">
 ...
 <template>
              ...
              <div class="ml-3 relative">
                <div>
                  <button
                    ...
                    class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-gray-800"
                    id="user-menu"
                    aria-haspopup="true"
                  >
  ...
  -->
      ...
      <!-- Option 2 -->
      <div class="mt-32 relative bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div class="-mr-2 -my-2 md:hidden">
              <button
                @click="showsmallscreen = !showsmallscreen"
                type="button"
