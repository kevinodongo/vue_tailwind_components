      ...
      <carousel :perPage="1">
        ...
        <slide>
          <img
            style="height: 600px"
            class="object-cover w-full"
            src="/lighthouse-5622924_640.jpg"
            alt="carousel image"
          />
        </slide>
        <slide>
          <img
            style="height: 600px"
            class="object-cover w-full"
            src="/tower-bridge-5762070_640.jpg"
            alt="carousel image"
          />
        </slide>
      </carousel>
