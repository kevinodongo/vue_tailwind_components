      ...
      >
        ...
        >
          <div>
            ...
            Showing
            <span class="font-medium" v-text="page"></span>
            to
            <span class="font-medium" v-text="numberOfPages"></span>
            of
            <span class="font-medium" v-text="items.length"></span>
            results
          </p>
          </div>
          <div>
